const pageConfig = {
  ...
  links: [
    ...
    { link: 'https://blog.060730.xyz/', label: '博客' },
  ],
  // [可选] 对监控进行分组
  // 如果不指定，所有监控将显示在一个列表中
...
const workerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '博客总入口',
      method: 'HEAD',
      target: 'https://blog.060730.xyz/',
      statusPageLink: 'https://blog.060730.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      id: 'helo',
      name: '主页（EdgeOne Pages国内节点）',
      method: 'HEAD',
      target: 'https://www.peroe.top/',
      statusPageLink: 'https://www.peroe.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      id: 'blog_cf',
      name: 'tg（Cloudflare Pages海外节点）',
      method: 'HEAD',
      target: 'https://tg.157658.xyz/',
      statusPageLink: 'https://tg.157658.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Umami（NAS）',
      method: 'HEAD',
      target: 'https://um.060730.xyz/',
      statusPageLink: 'https://um.060730.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      method: 'HEAD',
      target: 'https://vw.157658.xyz/',
      statusPageLink: 'https://vw.157658.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '飞牛（NAS）',
      method: 'HEAD',
      target: 'http://nas.peroe.top/',
      statusPageLink: 'http://nas.peroe.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      method: 'HEAD',
      target: 'https://git.060730.xyz/',
      statusPageLink: 'https://git.060730.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '随机图API（EdgeOne）',
      method: 'HEAD',
      target: 'https://eopfapi.0721030.xyz/pic',
      statusPageLink: 'https://eopfapi.0721030.xyz/pic/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      id: 'eo-apicc',
      name: '静态随机图api（EdgeOne Pages）',
      method: 'GET',
      target: 'https://pic.0721030.xyz/',
      statusPageLink: 'https://pic.0721030.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      id: 'ueo-hualang',
      name: '随机图画廊静态（EdgeOne Pages）',
      method: 'GET',
      target: 'https://gallery.0721030.xyz//',
      statusPageLink: 'https://gallery.0721030.xyz//',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
